...
（表格布局的使用例子、label.setPixmap(QPixmap('./images/book1.png')) #在QLable里显示图像）
'''
import sys
...
class ClipBoard(QDialog):
    def __init__(self):
      ...
      #  self.imageLabel.setPixmap(QPixmap('./images/book1.png')) #在QLable里显示图像
    ...
    def copyImage(self):
        clipboard = QApplication.clipboard()
        clipboard.setPixmap(QPixmap('G:\\pyqt5_GUI\\controls\\images\\screen.png'))
